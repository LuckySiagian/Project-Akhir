<nav class="navbar navbar-dark navbar-expand-lg" style="background-color: #bcaa7d">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="{{ asset('assets/images/2.png') }}" alt="Logo" width="250px" class="d-inline-block align-top" loading="lazy">
